...
description: "Explore the risks associated with poorly secured cameras and learn how attackers exploit default credentials to gain unauthorized access."
pubDate: "16 May 2024"
...
security cameras. With such a simple oversight you are allowing intruders into your home or business
and losing all privacy.
...
Using powerful search engines like Shodan and Censys, it makes finding internet connected devices
trivial. Unlike your regular search engine (eg google), these search engines are used to find
...
Shodan and Censys both provide convenient APIs to search through their databases. The API will return
...
page. With this information an attacker can programmatically attempt to login:
...
automate the whole process - available on my [GitHub](https://github.com/member87/cam-finder)

## What Can Attackers Access?

Once logged in as an admin, the attacker will have full control over the cameras. This includes:

- **Live Viewing & Playback**: Watch the cameras in real time and previous historical recordings.
...
- **Limit Internet Exposure**: Don't make your devices available publically on the
  internet unless absolutely required. In these cases there should be sufficient
...
- **IP Whitelist or VPN**: If you need remote access, limit which IPs can have access
  or use a VPN to securely connect.
